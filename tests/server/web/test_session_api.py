...
def test_upload_setup_teardown_errors(
    ...
    result = api_client.stream_jsonl(setup_teardown_errors_jsonl)
...
def test_sessions_list_api(
    ...
    api_client.stream_jsonl(mixed_outcomes_jsonl)
...
def test_upload_xfail(api_client: APIClient, xfail_jsonl: str) -> None:
    ...
    result = api_client.stream_jsonl(xfail_jsonl)
...
def test_upload_xpass(api_client: APIClient, xpass_jsonl: str) -> None:
    ...
    result = api_client.stream_jsonl(xpass_jsonl)
...
def test_upload_xfail_xpass_mixed(
    ...
    result = api_client.stream_jsonl(xfail_xpass_mixed_jsonl)
