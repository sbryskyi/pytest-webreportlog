...
def test_upload_empty_file(api_client: APIClient) -> None:
...
def test_upload_malformed_json(api_client: APIClient) -> None:
...
def test_upload_missing_required_fields(api_client: APIClient) -> None:
