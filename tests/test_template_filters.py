...
def test_strip_ansi_none_input() -> None:
...
def test_strip_ansi_with_color_codes() -> None:
...
def test_strip_ansi_with_multiple_colors() -> None:
...
def test_strip_ansi_with_bold() -> None:
...
def test_strip_ansi_with_underline() -> None:
...
def test_strip_ansi_complex_ansi_sequence() -> None:
...
def test_strip_ansi_preserves_newlines() -> None:
...
def test_strip_ansi_integer_input() -> None:
...
def test_strip_ansi_list_input() -> None:
...
def test_strip_ansi_dict_input() -> None:
...
def test_strip_ansi_pytest_captured_output() -> None:
...
def test_strip_ansi_background_colors() -> None:
...
def test_strip_ansi_256_colors() -> None:
...
def test_strip_ansi_rgb_colors() -> None:
...
def test_strip_ansi_mixed_text_and_codes() -> None:
...
def test_strip_ansi_empty_ansi_codes() -> None:
...
def test_strip_ansi_unicode_with_ansi() -> None:
...
def test_strip_ansi_long_text() -> None:
...
def test_strip_ansi_malformed_ansi_codes() -> None:
...
def test_strip_ansi_consecutive_resets() -> None:
...
def test_strip_ansi_no_reset_code() -> None:
